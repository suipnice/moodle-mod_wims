...
$plugin->release = '0.5.7';          // Don't forget to update the version too.
$plugin->version = 2025041700;       // The current module version (Date: YYYYMMDDXX).
...
$plugin->supported = [403, 500];     // Moodle 4.3.x to 5.0.x are supported.
